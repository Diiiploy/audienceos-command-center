  ...
  public: {
    Tables: {
      ...
      client_contact: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_contact_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
            referencedRelation: "agency"
            referencedColumns: ["id"]
      ...
      document: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "document_file_search_store_id_fkey"
            columns: ["file_search_store_id"]
            isOneToOne: false
            referencedRelation: "file_search_store"
            referencedColumns: ["id"]
          },
          {
      ...
      file_search_store: {
        ...
        Relationships: [
          {
            foreignKeyName: "file_search_store_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: true
            referencedRelation: "agency"
            referencedColumns: ["id"]
