...
export function ClientDetailView({ clientId, onBack }: ClientDetailViewProps) {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      {/* Content */}
      <div className="flex-1 overflow-y-auto px-6 py-8 pb-[var(--chat-pb,0px)]">
          ...
          <TabsContent value="performance" className="space-y-4">
            ...
            {adPerfLoading ? (
              ...
              <Card className="p-8 text-center">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Link an ad account in the Integrations tab, then connect Google Ads or Meta to sync performance metrics.
                </p>
              </Card>
            ) : null}
          </TabsContent>
