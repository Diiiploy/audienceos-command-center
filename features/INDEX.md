...
|---------|--------|-----------|-------|
| seo-enriched-onboarding | 📝 Specced | [SEO-ENRICHED-ONBOARDING.md](SEO-ENRICHED-ONBOARDING.md) | **NEW (2026-01-09)**: Auto-fetch SEO data from DataForSEO on client onboarding. 4 integration points: Onboarding Modal, Client Profile, Performance Tab, Intelligence Center. 3 DU effort. $0.02/enrichment via chi-gateway. |
