...
/**
 * Fetch ad performance summary for a specific client.
 * Same return shape as fetchAdPerformanceSummary so dashboard components can be reused.
 */
export async function fetchClientAdPerformance(
  ...
  if (error) {
    console.error('[dashboard-queries] fetchClientAdPerformance error:', error)
  }
